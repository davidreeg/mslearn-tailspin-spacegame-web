...
# -------------------------------------------------------------------------------------------
# Sample build script for Space Game from Microsoft Learn docs:
# https://learn.microsoft.com/en-us/training/modules/create-a-build-pipeline/4-plan-build-tasks
#
# NOTE: 
# This build script doesn't deal with errors, notify anyone if build errors occur, 
# stop on error, or install tool dependencies.
# -------------------------------------------------------------------------------------------
